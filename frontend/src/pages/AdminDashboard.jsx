    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="w-64 bg-slate-900 text-white p-6 space-y-8 sticky top-0 h-screen">
        ...
        <nav className="space-y-4">
          <Link to="/admin/dashboard" className="flex items-center gap-3 text-blue-400 font-bold"><LayoutDashboard size={20}/> Dashboard</Link>
          <Link to="/admin/services" className="flex items-center gap-3 text-slate-400 hover:text-white transition"><Wrench size={20}/> Services</Link>
          <Link to="/admin/applications" className="flex items-center gap-3 text-slate-400 hover:text-white transition"><Users size={20}/> Applications</Link>
          <Link to="/admin/feedback" className="flex items-center gap-3 text-slate-400 hover:text-white transition"><MessageSquare size={20}/> Feedback</Link>
          <Link to="/admin/providers" className="flex items-center gap-3 text-slate-400 hover:text-white hover:bg-slate-800 p-2 rounded-lg transition"><Users size={20}/> Providers</Link>
          <Link to="/admin/reports" className="flex items-center gap-3 text-slate-400 hover:text-white transition"><FileText size={20}/> Reports</Link>
        </nav>
      </div>
